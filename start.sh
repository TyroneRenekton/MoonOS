...
i686-linux-gnu-ld -Ttext 0xc0001500 -e main -o build/kernel.bin build/main.o build/print.o build/interrupt.o build/timer.o build/init.o build/debug.o build/kernel.o 
